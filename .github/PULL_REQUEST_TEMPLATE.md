...
- [ ] Installer bytes are untouched — nothing is extracted, repacked or rewritten.
...
- [ ] Adversarial tests were added (a model or upstream response cannot move an unverified URL
      past the gate).
