...
public static class ConfigSettings
{
    ...
    private static string? GetValue(WgFetchConfig redacted, string name, out string? error)
    {
        ...
        {
            "outputdirectory" => redacted.OutputDirectory,
            "cachedirectory" => redacted.CacheDirectory,
            "modelsroot" => redacted.ModelsRoot,
            "threshold" => Format(redacted.Threshold),
            "architecture" => redacted.Architecture,
            "scope" => redacted.Scope,
            "keepversions" => Format(redacted.KeepVersions),
            "aimode" => redacted.AiMode,
            "aiendpoint" => redacted.AiEndpoint,
            "aimodel" => redacted.AiModel,
            "aikey" => redacted.AiKey,
            "searchprovider" => redacted.SearchProvider,
            "searchendpoint" => redacted.SearchEndpoint,
            "searchkey" => redacted.SearchKey,
            "githubtoken" => redacted.GithubToken,
            "loglevel" => redacted.LogLevel,
            "paralleldownloads" => Format(redacted.ParallelDownloads),
            "maxperhost" => Format(redacted.MaxPerHost),
            "plain" => Format(redacted.Plain),
