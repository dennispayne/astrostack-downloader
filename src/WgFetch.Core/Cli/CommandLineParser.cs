...
public static class CommandLineParser
{
    ...
    [
        ...
        new("prereqs", "Install or report on pinned models", Combine([new OptionSpec("--models-root", OptionArity.Value, "root directory holding pinned models"), new OptionSpec("--models-dir", OptionArity.Value, "model directory"), new OptionSpec("--include-llm", OptionArity.Flag, "also fetch Phi-3.5-mini"), new OptionSpec("--dry-run", OptionArity.Flag, "report only")]), ["install", "status"]),
