...
public static class CommandLineParser
{
    ...
    [
        ...
        new("config", "View or edit persisted settings", Combine([new OptionSpec("--interactive", OptionArity.Flag, "open the interactive configuration menu")]), ["set", "get", "list", "unset", "tui"], SubCommandOptional: true),
